...
function Cart() {
  ...
  useEffect(() => {
    fetch(`${process.env.REACT_APP_API}/getapi/${id}`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const handleBuyNow = async () => {
    ...
    try {
      const response = await fetch(`${process.env.REACT_APP_API}/buy`, {
        method: "POST",
  ...
  return (
    <div className="div-box">
      ...
      <img src={`${process.env.REACT_APP_API}/${product.file}`} alt={product.title} width="300px" />
